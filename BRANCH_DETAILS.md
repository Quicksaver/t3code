...
- Port upstream tool-activity and subagent changes into `WorkActivityRows.tsx`. Preserve live and failed tool styling, group expansion, expanded images and details, question-answer previews, tool icon resolution, and subagent status and token summaries.
