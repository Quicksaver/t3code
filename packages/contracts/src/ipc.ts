...
export interface T3HostLocalEnvironmentBootstrap {
...
export const T3HostLocalEnvironmentBootstrapSchema = Schema.Struct({
  environmentId: EnvironmentId,
  label: Schema.String,
...
export interface LocalApi {
  ...
  server: {
    ...
    listProviderSkills: (
      input: ServerProviderSkillsListInput,
    ) => Promise<ServerProviderSkillsListResult>;
