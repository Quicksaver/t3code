...
export const RPC_REQUIRED_SCOPES = {
  ...
  [MAGI_WS_METHODS.getOptions]: AuthOrchestrationReadScope,
  [MAGI_WS_METHODS.getSettings]: AuthOrchestrationReadScope,
  [MAGI_WS_METHODS.updateSettings]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.resetSettings]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.armThread]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.getArm]: AuthOrchestrationReadScope,
  [MAGI_WS_METHODS.disarmThread]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.cancelRun]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.continueRun]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.reconcileActions]: AuthOrchestrationOperateScope,
  [MAGI_WS_METHODS.listRuns]: AuthOrchestrationReadScope,
  [MAGI_WS_METHODS.getRunDetail]: AuthOrchestrationReadScope,
  [MAGI_WS_METHODS.exportDiagnostics]: AuthOrchestrationReadScope,
