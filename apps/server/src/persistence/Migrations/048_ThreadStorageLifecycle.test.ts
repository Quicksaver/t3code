...
layer("048 thread storage lifecycle", (it) => {
  it.effect("creates the final schema and queues existing threads", () =>
    Effect.gen(function* () {
      ...
      assert.deepStrictEqual(executed, [[48, "ThreadStorageLifecycle"]]);
