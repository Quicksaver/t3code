...
export default Effect.gen(function* () {
  // Upstream assigned migration 34 to snoozing while this fork had already
  // assigned 33 and 34 to subagent lineage. A database that recorded the
  // upstream migration skips both fork entries, so the first later migration
  // must idempotently establish the lineage columns before cold-storage glue
  // reads them.
