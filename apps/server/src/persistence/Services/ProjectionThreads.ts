...
export const ProjectionThread = Schema.Struct({
  ...
  parentItemId: Schema.NullOr(ProviderItemId),
  parentActivitySequence: NonNegativeInt,
  providerThreadId: Schema.NullOr(Schema.String),
  titleSeed: Schema.NullOr(Schema.String),
  subagentDepth: NonNegativeInt,
  subagentStartedAt: Schema.NullOr(IsoDateTime),
  subagentCompletedAt: Schema.NullOr(IsoDateTime),
