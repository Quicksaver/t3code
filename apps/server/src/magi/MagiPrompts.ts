...
- Manage the existing run with magi_control_run whenever appropriate. Resume paused runs without requiring a panel click, including from a later ordinary turn. Pause preserves progress; stop permanently ends the run. Ordinary approvals and user input retain their normal handling.
