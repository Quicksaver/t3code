...
describe("MessagesTimeline", () => {
  ...
  it("renders command work entries as expandable rows", () => {
  ...
  it("renders dynamic tool command metadata as expandable command rows", () => {
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        {...buildProps()}
        timelineEntries={[
  ...
  it("does not render typed non-command stdout as command details", () => {
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        {...buildProps()}
        timelineEntries={[
  ...
  it("renders file-change work entries as expandable rows", () => {
    const markup = renderToStaticMarkup(
      <MessagesTimeline
        {...buildProps()}
        timelineEntries={[
  ...
  it("renders trailing tool calls as part of the terminal assistant block", () => {
    ...
    const toolIndex = markup.indexOf('data-timeline-row-id="work-toggle:trailing-work-entry"');
