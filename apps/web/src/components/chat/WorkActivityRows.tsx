...
import { hasRenderableCommandOutputDetail } from "../../lib/workLogEntryDetails";
import { deriveWorkLogEntries, mergeDeferredCommandOutput } from "../../session-logic";
...
const PlainWorkEntryRow = memo(function PlainWorkEntryRow(props: {
  ...
  const toggleExpanded = useCallback(() => {
    ...
    setExpanded(next);
  }, [expanded, groupView, workEntry.id, props.onToggleEntry]);
  ...
  const canExpand = useMemo(
    ...
    [
      detailedWorkEntry,
      viewedImage,
      workEntry.commandOutputAvailable,
      workEntry.questionAnswer,
      showFailedIndicator,
      previewText,
    ],
