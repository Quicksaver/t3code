...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    vcs: {
      ...
      panelSnapshot: rpcClient.vcs.panelSnapshot,
      branchDetails: rpcClient.vcs.branchDetails,
      branchCommits: rpcClient.vcs.branchCommits,
      stashDetails: rpcClient.vcs.stashDetails,
