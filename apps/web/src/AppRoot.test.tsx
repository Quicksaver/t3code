...
import { ComposerDraftArchiveObserver } from "./composerDraftArchiveObserver";
...
describe("AppRoot", () => {
  it("shares the application atom registry with routed UI and renderer-wide desktop hosts", () => {
    ...
    expect(isValidElement(children[0]) && children[0].type).toBe(ComposerDraftArchiveObserver);
