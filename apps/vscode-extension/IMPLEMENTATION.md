...
This split branch is synchronized through `upstream/main` `2448212367b4348f39eaf5c2635eea6896218cba` (`chore(release): prepare v0.0.28`) as of 2026-06-30. The branch-specific implementation source of truth remains this file; root `CUSTOMIZED.md` is intentionally absent in this isolated branch.

After the 2026-06-30 upstream merge, Step 3 VS Code webview follow-up, and this documentation refresh are committed, `split/vscode-extension-work` is expected to be 23 commits ahead and 0 commits behind `upstream/main`. The branch diff against `upstream/main` is 124 files changed, 16421 insertions(+), and 493 deletions(-).
