...
export function NewTaskDraftScreen(props: {
  ...
  const composerMenu = useComposerCommandMenu({
    ...
    workspaceSkills: flow.selectedProviderSkills,
    workspaceSkillsIsPending: flow.selectedProviderSkillsIsPending,
    workspaceSkillsError: flow.selectedProviderSkillsError,
    hasThread: false,
    ...
    onWorkspaceSkillsLookupActiveChange: flow.setComposerSkillMenuActive,
  });
  ...
  const composerDock = (
    <View className="bg-sheet px-[12px] pt-1" style={{ paddingBottom: controlsBottomPadding }}>
      ...
      (composerMenu.items.length > 0 || composerMenu.trigger.kind === "skill") ? (
        <View className="mb-2">
